  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex w-full border-2 active:border-black rounded-xl mb-2 p-3 items-center justify-between"
      >
        <img
          className="h-12"
      ...
      <div
        ...
        className="flex w-full border-2 active:border-black rounded-xl p-3 items-center justify-between"
      >
        <img
          className="h-12"
